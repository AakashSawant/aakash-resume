(function ($) {
    ...
    var imJs = {
        ...
        testimonialActivation: function () {
            ...
            $(".portfolioList").click(function(e){
                var rowData = JSON.parse($(this).attr('data-row'))
                console.log(rowData)
                $('#exampleModalCenter').modal('show');
                $("#imgPort").attr('src',rowData.poster)
                $("#portDes").html(rowData.description)
                var tech = '';
                rowData.techonlogies.split(',').forEach(element => {
                    tech+='<a href="#" class="rn-btn thumbs-icon"><span>'+element+'</span><i data-feather="thumbs-up"></i></a>'
                });
                $("#tech").empty().append(tech)
                $("#title").text(rowData.projectName)
